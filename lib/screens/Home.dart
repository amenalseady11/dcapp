        ...
        setState(() {
         ...
         global.members.members.removeWhere((item) => item.firstName == null);
           global.members.members.removeWhere((item) => item.surName == null);
             global.members.members.removeWhere((item) => item.branch.branchName == null);
             global.members.members.removeWhere((item) => item.zone.zoneName == null);
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    Row(
                    children: <Widget>[
                      Padding(padding: EdgeInsets.only(left: MediaQuery.of(context).size.width/80)),
                      Image(
      ...
      body: ListView(
        ...
        Container(
          decoration: BoxDecoration(
              ...
              gradient: LinearGradient(colors: [Colors.blue.shade900, Colors.indigo],),
      ...
      children: <Widget>[
         ...
         _buildCard('Meetings', 'assets/register.png',Meeting(), context), 
        ...
        _buildCard('Testimony', 'assets/testimony.png', Testimony(),context),


        _buildCard('Devotionals ', 'assets/devotionals.png', DevotionalsPage(), context),
        
        _buildCard('Music ', 'assets/Music.png', MusicPage(),context),

        _buildCard('Books ', 'assets/book.jpg',BookPage(), context),

        _buildCard('Audio Messages', 'assets/audiomesages2.png',AudioMessagePage(), context),
